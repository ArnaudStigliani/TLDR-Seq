...
polyA_list=$data/reads_with_polyA.list
bam_genome=$data/mapping/trimmed_primary.bam
...
### Here, we reverse the read direction depending on the adapter orientation
...
samtools view $bam_polyA_renamed | awk '{print $1}'  > $results/mapped_all.list
