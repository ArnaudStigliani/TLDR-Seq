...
tss_window_plus_forward.bdg.name <-   file.path(in_dir, "tss_plus_window_forward_pAm.bdg")
tss_window_plus_reverse.bdg.name <-   file.path(in_dir, "tss_plus_window_reverse_pAm.bdg")
tss_window_minus_forward.bdg.name <-   file.path(in_dir, "tss_minus_window_forward_pAm.bdg")
tss_window_minus_reverse.bdg.name <-   file.path(in_dir, "tss_minus_window_reverse_pAm.bdg")
...
write.table(data.frame(levels.y), file.path(out_dir, "list_tss_sorted_pAm.tsv"), quote =FALSE, row.names=FALSE, col.names=FALSE )

all.df <- eiffel_all.df
write.table(all.df, file.path(out_dir, "cov_to_plot_pAm.tsv"), sep = "\t", quote = FALSE, row.names=FALSE )
